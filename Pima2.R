...
Pima2 = function(ConfigList, st){
  ConfigList = SetState(ConfigList, st, "Pma2") 
  
  set.seed(0)
  
  old <- Sys.time() # get start time
  data = read.table("D:/RProjects/OptTask/Data/fernandezMain/imbalanced/pima/pimaImb_5.dat", 
                    sep=",", 
                    fill=FALSE, 
                    strip.white=TRUE)
