...
Shuttle2vs4 = function(ConfigList, st){
  ConfigList = SetState(ConfigList, st, "stl2vs4") 
  
  set.seed(0)
  
  old <- Sys.time() # get start time
  data = read.table("D:/RProjects/OptTask/Data/fernandezMain/imbalanced/Shuttle2vs4/Shuttle2vs4.dat", 
                    sep=",", 
                    fill=FALSE, 
                    strip.white=TRUE)
