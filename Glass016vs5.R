...
Glass016vs5 = function(ConfigList, st){
  ConfigList = SetState(ConfigList, st, "Gls016_5") 
  
  set.seed(0)
  
  old <- Sys.time() # get start time
  data = read.table("D:/RProjects/OptTask/Data/fernandezMain/imbalanced/Glass016vs5/Glass016vs5.dat", 
                    sep=",", 
                    fill=FALSE, 
                    strip.white=TRUE)
