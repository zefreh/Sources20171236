...
ecoli1 = function(ConfigList, st){
  ConfigList = SetState(ConfigList, st, "ecl1") 
  
  set.seed(0)
  
  old <- Sys.time() # get start time
  data = read.table("D:/RProjects/OptTask/Data/fernandezMain/imbalanced/ecoli1/ecoli1.dat", 
                    sep=",", 
                    fill=FALSE, 
                    strip.white=TRUE)
