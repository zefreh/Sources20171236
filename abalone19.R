...
abalone19 = function(ConfigList, st){
  ConfigList = SetState(ConfigList, st, "ab19")
  
  set.seed(0)
  
  old <- Sys.time() # get start time
  data = read.table("D:/RProjects/OptTask/Data/fernandezMain/imbalanced/abalone19/abalone19_5.dat", 
                    sep=",", 
                    fill=FALSE, 
                    strip.white=TRUE)
