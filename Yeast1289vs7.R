...
Yeast1289vs7 = function(ConfigList, st){
  ConfigList = SetState(ConfigList, st, "Yst1289_7") 
  
  set.seed(0)
  
  old <- Sys.time() # get start time
  data = read.table("D:/RProjects/OptTask/Data/fernandezMain/imbalanced/Yeast1289vs7/Yeast1289vs7.dat", 
                    sep=",", 
                    fill=FALSE, 
                    strip.white=TRUE)
