...
page_blocks0 = function(ConfigList, st){
  ConfigList = SetState(ConfigList, st, "PB0") 
  
  set.seed(0)
  
  old <- Sys.time() # get start time
  data = read.table("D:/RProjects/OptTask/Data/fernandezMain/imbalanced/page_blocks0/page_blocks0.dat", 
                    sep=",", 
                    fill=FALSE, 
                    strip.white=TRUE)
