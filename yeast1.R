...
yeast1 = function(ConfigList, st){
  ConfigList = SetState(ConfigList, st, "yst1") 
  
  set.seed(0)
  
  old <- Sys.time() # get start time
  data = read.table("D:/RProjects/OptTask/Data/fernandezMain/imbalanced/yeast1/yeast1.dat", 
                    sep=",", 
                    fill=FALSE, 
                    strip.white=TRUE)
