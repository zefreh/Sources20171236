...
Yeast6 = function(ConfigList, st){
  ConfigList = SetState(ConfigList, st, "Yst6") 
  
  set.seed(0)
  
  old <- Sys.time() # get start time
  data = read.table("D:/RProjects/OptTask/Data/fernandezMain/imbalanced/Yeast6/Yeast6.dat", 
                    sep=",", 
                    fill=FALSE, 
                    strip.white=TRUE)
