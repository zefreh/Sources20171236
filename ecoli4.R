...
ecoli4 = function(ConfigList, st){
  ConfigList = SetState(ConfigList, st, "ecl4") 
  
  set.seed(0)
  
  old <- Sys.time() # get start time
  data = read.table("D:/RProjects/OptTask/Data/fernandezMain/imbalanced/ecoli4/ecoli4.dat", 
                    sep=",", 
                    fill=FALSE, 
                    strip.white=TRUE)
