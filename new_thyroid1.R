...
new_thyroid1 = function(ConfigList, st){
  ConfigList = SetState(ConfigList, st, "NTr1") 
  
  set.seed(0)
  
  old <- Sys.time() # get start time
  data = read.table("D:/RProjects/OptTask/Data/fernandezMain/imbalanced/new_thyroid1/new_thyroid1.dat", 
                    sep=",", 
                    fill=FALSE, 
                    strip.white=TRUE)
