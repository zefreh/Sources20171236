...
yeast3 = function(ConfigList, st){
  ConfigList = SetState(ConfigList, st, "yst3") 
  
  set.seed(0)
  
  old <- Sys.time() # get start time
  data = read.table("D:/RProjects/OptTask/Data/fernandezMain/imbalanced/yeast3/yeast3.dat", 
                    sep=",", 
                    fill=FALSE, 
                    strip.white=TRUE)
