...
Yeast5 = function(ConfigList, st){
  ConfigList = SetState(ConfigList, st, "Yst5") 
  
  set.seed(0)
  
  old <- Sys.time() # get start time
  data = read.table("D:/RProjects/OptTask/Data/fernandezMain/imbalanced/Yeast5/Yeast5.dat", 
                    sep=",", 
                    fill=FALSE, 
                    strip.white=TRUE)
